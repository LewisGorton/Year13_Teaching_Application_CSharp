...
My main advice to anyone wishing to run this project would be to copy and paste all of the .cs files into a project folder in Visual Studio, as all of the other files are egenrated automatically by Visual Studio.
